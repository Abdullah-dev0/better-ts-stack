...
<Card title="Frontend" href="/docs/modules/frontend" icon={<Layout className="text-green-400" />}>
	Next.js 16 with React 19 and Tailwind CSS v4 — automatically selected for every `fullstack` app type project
</Card>
...
<Callout type="info">
	Better Auth is only prompted for Next.js projects when a database has been selected. If database type is `none`, auth
