...
<Callout type="info">
	For Next.js projects, the auth prompt is automatically skipped if you chose `none` for the database type. Better Auth
	requires a database-backed adapter to function.
</Callout>
