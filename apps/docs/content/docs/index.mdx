...
<Cards>
  ...
  <Card title="Full-stack App" icon={<Layout className="text-green-400" />}>
    Next.js 16 or TanStack Start with React 19, Tailwind CSS v4, and file-based
    routing
  </Card>
  <Card
  ...
  <Card title="Authentication" icon={<Zap className="text-yellow-400" />}>
    JWT + bcrypt for Express, Better Auth (with Prisma, Drizzle, or MongoDB
    adapter) for Next.js and TanStack Start
  </Card>
