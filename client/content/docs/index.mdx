...
<Callout type="info" title="Good for">
	- Starting new TypeScript backend or full-stack projects - Prototyping APIs with a type-safe Express setup - Learning
	modern TypeScript project structure - Standardizing project scaffolding across a team
</Callout>
...
<Cards>
	...
	<Card title="Full-stack App" icon={<Layout className="text-green-400" />}>
		Next.js 16 with React 19, App Router, Tailwind CSS v4, and a proxy configuration
	</Card>
	...
	<Card title="Authentication" icon={<Zap className="text-yellow-400" />}>
		JWT + bcrypt for Express, Better Auth (with Prisma or Drizzle adapter) for Next.js
	</Card>
...
<Callout type="warn">Check your Node.js version before running: `node --version`</Callout>
