...
<Tabs items={["npm", "pnpm", "bun"]}>
	<Tab value="npm">```bash npm install -g better-ts-stack better-ts-stack ```</Tab>
	<Tab value="pnpm">```bash pnpm add -g better-ts-stack better-ts-stack ```</Tab>
...
<Callout type="info">**Update a global install:** ```bash npm update -g better-ts-stack ```</Callout>
