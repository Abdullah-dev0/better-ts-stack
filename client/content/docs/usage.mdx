...
- **For Next.js frontend:** Better Auth integration with Prisma or Drizzle (PostgreSQL)
...
<Callout type="info">
  For Next.js projects in this CLI, Better Auth requires a database selection.
  If you choose Drizzle + Better Auth, generated schema includes Better Auth core
